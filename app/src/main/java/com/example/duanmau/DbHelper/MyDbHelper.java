...
public class MyDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String insThuThu = "INSERT INTO ThuThu(maTT, hoTen, matKhau) VALUES('admin', 'Nguyen Sơn Dương', '12345')";
        ...
        String insSach = "INSERT INTO Sach(maSach, TenSach, GiaTHue, maLS) VALUES('S001', 'Lập trình Java 1', 2000, 1), ('S002', 'Kinh Tế Vĩ Mô', 5000, 2), ('SAT1', '1000 Công thức làm bánh', 4675, 3)";
        db.execSQL(insSach);
        ...
        String insPhieuMuon = "INSERT INTO PhieuMuon VALUES('PM01', 'TV01', 'TT01', 'S001', '29/08/2021', 'Chưa trả', 20000)";
